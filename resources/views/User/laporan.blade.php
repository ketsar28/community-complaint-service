...
<div class="container">
    <div class="row justify-content-between">
        <div class="col-lg-8 col-md-12 col-sm-12 col-12 col">
            <div class="content content-top shadow rounded-lg">
                @if ($errors->any())
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 col-12 col">
            <div class="content content-bottom shadow rounded-lg">
                <div>
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-8">
            ...
            <div class="laporan-bottom">
                ...
                @endif
                @if ($v->tanggapan != null)
                <p class="mt-3 mb-1"><ion-icon name="chatbubble-ellipses"></ion-icon> {{ 'Tanggapan dari '. $v->tanggapan->petugas->nama_petugas }}</p>
