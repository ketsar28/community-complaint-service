        ...
        <div class="container">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="log-container navbar-nav text-center ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pekat.laporan') }}">Laporan</a>
                        </li>
                        <li class="nav-item">
                            <a class="log-wrap nav-link ml-2" href="{{ route('pekat.logout') }}">{{ Auth::guard('masyarakat')->user()->nama }} <box-icon name='log-out' color='red'></box-icon></a>
                        </li>
                    </ul>
                    @else
                    <ul class="login-web navbar-nav text-center ml-auto">
                        <li class="nav-item">
...
<div class="copyright">
    {{-- <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2023 Ketsar Ali • All Rights Reserved</p>
    </div> --}}
    <footer>
    <div class="waves">
   ...
   <div class="container-footer">
        <ul class="menu">
            <p><ion-icon name="location-sharp"></ion-icon> Jl. Kp. Melayu Kecil, Tebet </p> 
            <p><ion-icon name="mail-sharp"></ion-icon> kelbukitduri@gmail.com</p>
            <p><ion-icon name="call-sharp"></ion-icon> (021) 851616</p>
        </ul>
        <ul class="icons">
          <li>
            <a href="#">
    ...
    <p class="italic text-secondary copyright">&copy; 2023 All Rights Reserved •  Ketsar Ali </p>
  </footer>
</div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form action="{{ route('pekat.login') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-purple text-white my-3" style="width: 100%">MASUK</button>
                    <div class="log-admin text-decoration-none text-center">
                        <a href="/admin">Sebagai admin? klik disini </a><i class="fa-duotone fa-right-to-bracket"></i>
                    </div>
                </form>
